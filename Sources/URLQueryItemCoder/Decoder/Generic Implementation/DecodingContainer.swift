...
enum DecodingContainer<PrimitiveValue> where PrimitiveValue: DecodingPrimitiveValue {
    ...
    var configuration: DecodingStrategies {
        switch self {
    ...
    func expectedSingleValueContainer(at codingPath: [any CodingKey]) throws -> SingleValue {
        switch self {
        case .multiValue:
